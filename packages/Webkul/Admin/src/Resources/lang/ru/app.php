...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'Пароль',
            'powered-by-description' => 'Работает на :CastMart, проект с открытым исходным кодом от :webkul.',
            'submit-btn'             => 'Войти',
            'title'                  => 'Войти',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Работает на :CastMart, проект с открытым исходным кодом от :webkul.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Разработано на платформе <a href="https://CastMart.com/" target="_blank">CastMart</a>, Проект сообщества <a href="https://webkul.com/" target="_blank">Webkul</a>',
    ],
