...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'Пароль',
            'powered-by-description' => 'Працює на платформі :CastMart, спільний проект :webkul.',
            'submit-btn'             => 'Увійти',
            'title'                  => 'Увійти',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Працює на платформі :CastMart, спільний проект :webkul.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Працює на платформі <a href="https://CastMart.com/" target="_blank">CastMart</a>, Спільний проект <a href="https://webkul.com/" target="_blank">Webkul</a>',
    ],
