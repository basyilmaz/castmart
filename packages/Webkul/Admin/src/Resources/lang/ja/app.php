...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'パスワード',
            'powered-by-description' => ':webkul によるオープンソースプロジェクト :CastMart によって提供されています。',
            'submit-btn'             => 'サインイン',
            'title'                  => 'サインイン',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => ':webkul によるオープンソースプロジェクト :CastMart によって提供されています。',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '搭載 <a href="https://CastMart.com/" target="_blank">CastMart</a>, Webkulによるコミュニティプロジェクト<a href="https://webkul.com/" target="_blank">Webkul</a>',
    ],
