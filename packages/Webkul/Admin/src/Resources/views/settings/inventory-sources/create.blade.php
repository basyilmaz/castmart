<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.inventory_sources.create.before') !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.settings.inventory_sources.create.create_form_controls.before') !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.settings.inventory_sources.create.card.general.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.inventory_sources.create.card.general.after') !!}

                {!! view_render_event('CastMart.admin.settings.inventory_sources.create.card.contact_info.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.inventory_sources.create.card.contact_info.after') !!}

                {!! view_render_event('CastMart.admin.settings.inventory_sources.create.card.address.before') !!}

                <!-- Source Address -->
                <v-source-address></v-source-address>

                {!! view_render_event('CastMart.admin.settings.inventory_sources.create.card.address.after') !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2">
                ...
                {!! view_render_event('CastMart.admin.settings.inventory_sources.create.card.accordion.settings.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.inventory_sources.create.card.accordion.settings.after') !!}

            </div>
        </div>

        {!! view_render_event('CastMart.admin.settings.inventory_sources.create.create_form_controls.after') !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.settings.inventory_sources.create.after') !!}
