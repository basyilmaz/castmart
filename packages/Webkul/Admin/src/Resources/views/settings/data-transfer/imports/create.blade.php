<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.before') !!}

    <x-admin::form
        :action="route('admin.settings.data_transfer.imports.store')"
        enctype="multipart/form-data"
    >
        {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.create_form_controls.before') !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.card.general.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.card.general.after') !!}
            </div>

            <!-- Right Container -->
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.card.accordion.settings.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.card.accordion.settings.after') !!}
            </div>
        </div>

        {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.create_form_controls.after') !!}
    </x-admin::form>
</x-admin::layouts>
