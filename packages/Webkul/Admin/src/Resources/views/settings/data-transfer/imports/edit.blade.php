<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.before', ['import' => $import]) !!}
    ...
    >
        {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.create_form_controls.before', ['import' => $import]) !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.card.general.before', ['import' => $import]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.card.general.after', ['import' => $import]) !!}
            </div>

            <!-- Right Container -->
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.card.accordion.settings.before', ['import' => $import]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.card.accordion.settings.after', ['import' => $import]) !!}
            </div>
        </div>

        {!! view_render_event('CastMart.admin.settings.data_transfer.imports.create.create_form_controls.after', ['import' => $import]) !!}
    </x-admin::form>
</x-admin::layouts>
