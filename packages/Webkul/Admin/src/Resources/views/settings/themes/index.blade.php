<x-admin::layouts>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-x-2.5">
            <div class="flex items-center gap-x-2.5">
                {!! view_render_event('CastMart.admin.settings.themes.create.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.themes.create.after') !!}
            </div>
        </div>
    </div>
    
    {!! view_render_event('CastMart.admin.settings.themes.list.before') !!}

    <x-admin::datagrid :src="route('admin.settings.themes.index')" />

    {!! view_render_event('CastMart.admin.settings.themes.list.after') !!}
