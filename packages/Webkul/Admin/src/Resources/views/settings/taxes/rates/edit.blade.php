<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.taxes.rates.edit.before', ['taxRate' => $taxRate]) !!}
    ...
    {!! view_render_event('CastMart.admin.settings.taxes.rates.edit.after', ['taxRate' => $taxRate]) !!}
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('CastMart.admin.settings.taxes.rates.edit.edit_form_controls.before', ['taxRate' => $taxRate]) !!}
            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    ...
                    {!! view_render_event('CastMart.admin.settings.taxes.rates.edit.card.accordion.basic_settings.before', ['taxRate' => $taxRate]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.settings.taxes.rates.edit.card.accordion.basic_settings.after', ['taxRate' => $taxRate]) !!}

                </div>
            </div>

            {!! view_render_event('CastMart.admin.settings.taxes.rates.edit.edit_form_controls.after', ['taxRate' => $taxRate]) !!}
