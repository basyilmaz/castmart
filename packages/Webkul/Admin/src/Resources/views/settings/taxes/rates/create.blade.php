<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.taxes.rates.create.before') !!}
    ...
    {!! view_render_event('CastMart.admin.settings.taxes.rates.create.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('CastMart.admin.settings.taxes.rates.create.create_form_controls.before') !!}
            ...
            {!! view_render_event('CastMart.admin.settings.taxes.rates.create.create_form_controls.after') !!}
