<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.exchange_rates.create.before') !!}
    ...
    {!! view_render_event('CastMart.admin.settings.exchange_rates.create.after') !!}
            ...
            >
                ...
                >
                    ...
                    <x-admin::modal ref="exchangeRateUpdateOrCreateModal">
                        ...
                        <!-- Modal Content -->
                        <x-slot:content>
                            {!! view_render_event('CastMart.admin.settings.exchangerate.create.before') !!}
