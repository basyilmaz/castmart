...
<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.channels.edit.before', ['channel' => $channel]) !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.settings.channels.edit.edit_form_controls.before', ['channel' => $channel]) !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.settings.channels.edit.card.general.before', ['channel' => $channel]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.edit.card.general.after', ['channel' => $channel]) !!}

                {!! view_render_event('CastMart.admin.settings.channels.edit.card.design.before', ['channel' => $channel]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.edit.card.design.after', ['channel' => $channel]) !!}

                {!! view_render_event('CastMart.admin.settings.channels.edit.card.seo.before', ['channel' => $channel]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.edit.card.seo.after', ['channel' => $channel]) !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                {!! view_render_event('CastMart.admin.settings.channels.edit.card.accordion.currencies_and_locales.before', ['channel' => $channel]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.edit.card.accordion.currencies_and_locales.after', ['channel' => $channel]) !!}
                
                {!! view_render_event('CastMart.admin.settings.channels.edit.card.accordion.settings.before', ['channel' => $channel]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.edit.card.accordion.settings.after', ['channel' => $channel]) !!}

            </div>
        </div>

        {!! view_render_event('CastMart.admin.settings.channels.edit.edit_form_controls.after', ['channel' => $channel]) !!}

    </x-admin::form> 

    {!! view_render_event('CastMart.admin.settings.channels.edit.after', ['channel' => $channel]) !!}
