<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.channels.create.before') !!}
    ...
    >
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.settings.channels.create.card.general.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.create.card.general.after') !!}

                {!! view_render_event('CastMart.admin.settings.channels.create.card.design.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.create.card.design.after') !!}

                {!! view_render_event('CastMart.admin.settings.channels.create.card.seo.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.create.card.seo.after') !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                {!! view_render_event('CastMart.admin.settings.channels.create.card.accordion.currencies_and_locales.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.create.card.accordion.currencies_and_locales.after') !!}

                {!! view_render_event('CastMart.admin.settings.channels.create.card.accordion.settings.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.channels.create.card.accordion.settings.after') !!}
    ...
    {!! view_render_event('CastMart.admin.settings.channels.create.after') !!}
</x-admin::layouts>
