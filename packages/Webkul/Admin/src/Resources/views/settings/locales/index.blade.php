<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.locales.create.before') !!}
    ...
    {!! view_render_event('CastMart.admin.settings.locales.create.after') !!}
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {!! view_render_event('CastMart.admin.settings.locales.create_form_controls.before') !!}
                    ...
                    <x-admin::modal ref="localeUpdateOrCreateModal">
                        ...
                        <!-- Modal Content -->
                        <x-slot:content>
                            {!! view_render_event('CastMart.admin.settings.locale.create.before') !!}
                            ...
                            {!! view_render_event('CastMart.admin.settings.locale.create.after') !!}
                        </x-slot>
                    ...
                    {!! view_render_event('CastMart.admin.settings.locales.create_form_controls.after') !!}
