<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.roles.edit.before', ['role' => $role]) !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.settings.roles.edit.edit_form_controls.before', ['role' => $role]) !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.settings.roles.edit.card.access-control.before', ['role' => $role]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.roles.edit.card.access-control.after', ['role' => $role]) !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                {!! view_render_event('CastMart.admin.settings.roles.edit.card.accordion.general.before', ['role' => $role]) !!}
                ...
                {!! view_render_event('CastMart.admin.settings.roles.edit.card.accordion.general.after', ['role' => $role]) !!}

            </div>
        </div>

        {!! view_render_event('CastMart.admin.settings.roles.edit.edit_form_controls.after', ['role' => $role]) !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.settings.roles.edit.after', ['role' => $role]) !!}
