<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.settings.roles.create.before') !!}

    <x-admin::form :action="route('admin.settings.roles.store')">

        {!! view_render_event('CastMart.admin.settings.roles.create.create_form_controls.before') !!}
        ...
        <div class="flex items-center justify-between">
         ...
         <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.settings.roles.create.card.access_control.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.roles.create.card.access_control.after') !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                {!! view_render_event('CastMart.admin.settings.roles.create.card.accordion.general.before') !!}
                ...
                {!! view_render_event('CastMart.admin.settings.roles.create.card.accordion.general.after') !!}

            </div>
        </div>

        {!! view_render_event('CastMart.admin.settings.roles.create.create_form_controls.after') !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.settings.roles.create.after') !!}
