...
<x-admin::layouts>
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.cms.pages.edit.create_form_controls.before', ['page' => $page]) !!}
        ...
        <div class="mt-7 flex items-center justify-between gap-4 max-md:flex-wrap">
          ...
          <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.cms.pages.edit.card.content.before', ['page' => $page]) !!}
                ...
                {!! view_render_event('CastMart.admin.cms.pages.edit.card.content.after', ['page' => $page]) !!}

                {!! view_render_event('CastMart.admin.cms.pages.edit.card.seo.before', ['page' => $page]) !!}
                ...
                {!! view_render_event('CastMart.admin.cms.pages.edit.card.seo.after', ['page' => $page]) !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                {!! view_render_event('CastMart.admin.cms.pages.edit.card.accordion.seo.before', ['page' => $page]) !!}
                ...
                {!! view_render_event('CastMart.admin.cms.pages.edit.card.accordion.seo.after', ['page' => $page]) !!}

            </div>
          </div>

        {!! view_render_event('CastMart.admin.cms.pages.edit.create_form_controls.after', ['page' => $page]) !!}
