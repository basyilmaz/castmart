<x-admin::layouts>
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.cms.pages.create.create_form_controls.before') !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.cms.pages.create.card.description.before') !!}
                ...
                {!! view_render_event('CastMart.admin.cms.pages.create.card.description.after') !!}

                {!! view_render_event('CastMart.admin.cms.pages.create.card.seo.before') !!}
                ...
                {!! view_render_event('CastMart.admin.cms.pages.create.card.seo.after') !!}
            </div>
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                {!! view_render_event('CastMart.admin.cms.pages.create.card.accordion.general.before') !!}
                ...
                {!! view_render_event('CastMart.admin.cms.pages.create.card.accordion.general.after') !!}

            </div>
        </div>

        {!! view_render_event('CastMart.admin.cms.pages.create.create_form_controls.after') !!}
