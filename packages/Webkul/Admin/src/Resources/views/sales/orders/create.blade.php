    ...
    @pushOnce('scripts')
        ...
        >
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                <!-- Left Component -->
                {!! view_render_event('CastMart.admin.sales.order.create.left_component.before') !!}
                        ...
                        >
                            <x-admin::drawer ref="productConfigurationDrawer">
                                ...
                                <x-slot:content class="!p-0">
                                    {!! view_render_event('CastMart.admin.sales.order.create.product_options.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.admin.sales.order.create.product_options.after') !!}
                                </x-slot>
                            </x-admin::drawer>
                        </form>
                    </x-admin::form>
                ...
                {!! view_render_event('CastMart.admin.sales.order.create.left_component.after') !!}

                <!-- Right Component -->
                {!! view_render_event('CastMart.admin.sales.order.right_component.before') !!}
                ...
                {!! view_render_event('CastMart.admin.sales.order.create.right_component.after') !!}
            </div>
        </script>
