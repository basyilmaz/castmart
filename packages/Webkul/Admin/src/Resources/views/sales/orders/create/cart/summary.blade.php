{!! view_render_event('CastMart.admin.sales.order.create.cart.summary.before') !!}
...
{!! view_render_event('CastMart.admin.sales.order.create.cart.summary.after') !!}
        ...
        >
            ...
            <div class="grid w-full justify-end gap-2.5 border-b p-4 dark:border-gray-800">
                <div class="grid gap-4">
                    <!-- Sub Total -->
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.sub_total.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.sub_total.after') !!}


                    <!-- Taxes -->
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.tax.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.tax.after') !!}

                    <!-- Shipping Rates -->
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.delivery_charges.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.delivery_charges.after') !!}

                    <!-- Discount -->
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.discount_amount.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.discount_amount.after') !!}


                    <!-- Discount -->
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.coupon.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.coupon.after') !!}

                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.coupon.after') !!}

                    <!-- Cart Grand Total -->
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.grand_total.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.grand_total.after') !!}
                </div>
            </div>
            ...
            >
                ...
                <form @submit="handleSubmit($event, applyCoupon)">
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.coupon_form_controls.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.sales.order.create.left_component.summary.coupon_form_controls.after') !!}
                </form>
            </x-admin::form>
        </div>
    </script>
