{!! view_render_event('CastMart.admin.sales.order.create.cart.items.before') !!}
...
{!! view_render_event('CastMart.admin.sales.order.create.cart.items.after') !!}
    ...
    >
        <div class="box-shadow rounded bg-white dark:bg-gray-900">
            ...
            <div
                ...
                v-else
            >
                <img src="{{ CastMart_asset('images/icon-add-product.svg') }}" class="h-20 w-20 dark:mix-blend-exclusion dark:invert">
