{!! view_render_event('CastMart.admin.sales.order.create.recent_order_items.before') !!}
...
{!! view_render_event('CastMart.admin.sales.order.create.recent_order_items.after') !!}
