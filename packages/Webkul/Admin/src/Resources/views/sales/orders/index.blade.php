<x-admin::layouts>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        ...
        <div class="flex items-center gap-x-2.5">
            ...
            {!! view_render_event('CastMart.admin.sales.orders.create.before') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.orders.create.after') !!}
        </div>
    </div>
                ...
                >
                    ...
                    <x-slot:content class="!p-0">
                        ...
                        >
                            <!-- Placeholder Image -->
                            <img
                                src="{{ CastMart_asset('images/empty-placeholders/customers.svg') }}"
