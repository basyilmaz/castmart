@pushOnce('scripts')
    ...
    >
        <div class="mt-2">
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.company_name.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.vat_id.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.first_name.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.last_name.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.email.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.address.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.country.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.state.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.city.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.postcode.after') !!}
            ...
            {!! view_render_event('CastMart.admin.sales.order.create.cart.address.form.phone.after') !!}
        </div>
    </script>
