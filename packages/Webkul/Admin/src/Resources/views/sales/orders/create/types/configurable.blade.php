{!! view_render_event('CastMart.admin.sales.order.create.types.configurable.before') !!}
...
{!! view_render_event('CastMart.admin.sales.order.create.types.configurable.after') !!}
