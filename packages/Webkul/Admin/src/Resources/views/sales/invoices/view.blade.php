<x-admin::layouts>
    ...
    <div class="grid">
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            {!! view_render_event('CastMart.admin.sales.invoice.title.before', ['order' => $order]) !!}
            ...
            {!! view_render_event('CastMart.admin.sales.invoice.title.after', ['order' => $order]) !!}
    ...
    <div class="mt-7 flex items-center justify-between gap-4 max-md:flex-wrap">
        <div class="flex flex-wrap items-center gap-x-1 gap-y-2">
            {!! view_render_event('CastMart.admin.sales.invoice.page_action.before', ['order' => $order]) !!}
            ...
            {!! view_render_event('CastMart.admin.sales.invoice.page_action.after', ['order' => $order]) !!}
            ...
            <x-admin::accordion>
                ...
                <x-slot:content>
                    <div class="flex flex-col {{ $order->billing_address ? 'pb-4' : ''}}">
                        ...
                        {!! view_render_event('CastMart.admin.sales.invoice.customer_name.after', ['order' => $order]) !!}

                        <p class="text-gray-600 dark:text-gray-300">
                            @lang('admin::app.sales.invoices.view.customer-email', ['email' => $invoice->order->customer_email])
                        </p>

                        {!! view_render_event('CastMart.admin.sales.invoice.customer_email.after', ['order' => $order]) !!}
                    </div>
                    ...
                    @if ($order->billing_address || $order->shipping_address)
                        ...
                        @if ($order->billing_address)
                            <div class="{{ $order->shipping_address ? 'pb-4' : '' }}">
                                ...
                                {!! view_render_event('CastMart.admin.sales.invoice.billing_address.after', ['order' => $order]) !!}
                            </div>
                        @endif
                        ...
                        @if ($order->shipping_address)
                            ...
                            {!! view_render_event('CastMart.admin.sales.invoice.shipping_address.after', ['order' => $order]) !!}
                        @endif
                    @endif
                </x-slot>
            </x-admin::accordion>
                ...
                <x-slot:content>
                    <div class="flex w-full justify-start gap-5">
                        ...
                        <div class="flex flex-col gap-y-1.5">
                            ...
                            {!! view_render_event('CastMart.admin.sales.invoice.increment_id.after', ['order' => $order]) !!}
                            ...
                            {!! view_render_event('CastMart.admin.sales.invoice.created_at.after', ['order' => $order]) !!}
                            ...
                            {!! view_render_event('CastMart.admin.sales.invoice.status_label.after', ['order' => $order]) !!}
                            ...
                            {!! view_render_event('CastMart.admin.sales.invoice.channel_name.after', ['order' => $order]) !!}
                        </div>
                    </div>
                </x-slot>
            </x-admin::accordion>
