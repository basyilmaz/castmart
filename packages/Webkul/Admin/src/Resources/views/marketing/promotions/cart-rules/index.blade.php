<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.promotions.cart-rules.list.before') !!}

    <x-admin::datagrid :src="route('admin.marketing.promotions.cart_rules.index')" />

    {!! view_render_event('CastMart.admin.marketing.promotions.cart-rules.list.after') !!}
