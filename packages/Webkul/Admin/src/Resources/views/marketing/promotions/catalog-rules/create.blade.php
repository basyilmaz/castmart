<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.before') !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.create_form_controls.before') !!}
        ...
        {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.create_form_controls.after') !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.after') !!}
        ...
        >
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.general.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.general.after') !!}

                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.conditions.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.conditions.after') !!}

                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.actions.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.actions.after') !!}

                </div>

                <!-- Right sub-components -->
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.accordion.settings.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.accordion.settings.after') !!}

                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.accordion.marketing_time.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.card.accordion.marketing_time.after') !!}
