<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.before', ['catalogRule' => $catalogRule]) !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.create_form_controls.before', ['catalogRule' => $catalogRule]) !!}
        ...
        {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.create.create_form_controls.after', ['catalogRule' => $catalogRule]) !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.after', ['catalogRule' => $catalogRule]) !!}
        ...
        >
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.general.before', ['catalogRule' => $catalogRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.general.after', ['catalogRule' => $catalogRule]) !!}

                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.conditions.before', ['catalogRule' => $catalogRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.conditions.after', ['catalogRule' => $catalogRule]) !!}

                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.actions.before', ['catalogRule' => $catalogRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.actions.after', ['catalogRule' => $catalogRule]) !!}
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.accordion.settings.before', ['catalogRule' => $catalogRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.accordion.settings.after', ['catalogRule' => $catalogRule]) !!}

                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.accordion.marketing_time.before', ['catalogRule' => $catalogRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.edit.card.accordion.marketing_time.after', ['catalogRule' => $catalogRule]) !!}
