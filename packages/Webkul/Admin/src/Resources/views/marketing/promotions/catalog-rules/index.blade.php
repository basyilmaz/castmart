<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.list.before') !!}

    <x-admin::datagrid :src="route('admin.marketing.promotions.catalog_rules.index')" />

    {!! view_render_event('CastMart.admin.marketing.promotions.catalog_rules.list.after') !!}
