<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.before', ['cartRule' => $cartRule]) !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.edit_form_controls.before', ['cartRule' => $cartRule]) !!}
        ...
        {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.edit_form_controls.after', ['cartRule' => $cartRule]) !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.after', ['cartRule' => $cartRule]) !!}
        ...
        >
            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.general.before', ['cartRule' => $cartRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.general.after', ['cartRule' => $cartRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.conditions.before', ['cartRule' => $cartRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.conditions.after', ['cartRule' => $cartRule]) !!}

                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.actions.before', ['cartRule' => $cartRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.actions.after', ['cartRule' => $cartRule]) !!}
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.accordion.settings.before', ['cartRule' => $cartRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.accordion.settings.after', ['cartRule' => $cartRule]) !!}

                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.accordion.marketing_time.before', ['cartRule' => $cartRule]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.promotions.cart_rules.edit.card.accordion.marketing_time.after', ['cartRule' => $cartRule]) !!}
