<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.search_seo.search_terms.create.before') !!}
    ...
    {!! view_render_event('CastMart.admin.marketing.search_seo.search_terms.create.after') !!}
