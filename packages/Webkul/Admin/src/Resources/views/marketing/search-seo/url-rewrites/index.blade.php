<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.search_seo.url_rewrites.create.before') !!}
    ...
    {!! view_render_event('CastMart.admin.marketing.search_seo.url_rewrites.create.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('CastMart.admin.marketing.search_seo.url_rewrites.list.before') !!}
            ...
            {!! view_render_event('CastMart.admin.marketing.search_seo.url_rewrites.list.after') !!}
