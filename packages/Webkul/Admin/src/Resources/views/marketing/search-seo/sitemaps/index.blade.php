<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.search_seo.sitemaps.create.before') !!}
    ...
    {!! view_render_event('CastMart.admin.marketing.search_seo.sitemaps.create.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('CastMart.admin.marketing.search_seo.sitemaps.list.before') !!}
            ...
            {!! view_render_event('CastMart.admin.marketing.search_seo.sitemaps.list.after') !!}
