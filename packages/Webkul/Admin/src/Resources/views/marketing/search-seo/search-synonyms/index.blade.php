<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.search_seo.search_synonyms.create.before') !!}
    ...
    {!! view_render_event('CastMart.admin.marketing.search_seo.search_synonyms.create.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('CastMart.admin.marketing.search_seo.search_synonyms.list.before') !!}
