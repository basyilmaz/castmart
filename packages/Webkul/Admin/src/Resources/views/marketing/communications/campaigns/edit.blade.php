<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.communications.campaigns.edit.before', ['campaign' => $campaign]) !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.create_form_controls.before', ['campaign' => $campaign]) !!}
        ...
        <div class="mb-2 mt-7 flex gap-2.5">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.campaigns.edit.card.general.before', ['campaign' => $campaign]) !!}
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.campaigns.edit.card.general.after', ['campaign' => $campaign]) !!}
            </div>

             <!-- Right Section -->
             <div class="flex w-[360px] max-w-full flex-col gap-2 max-md:w-full">

                {!! view_render_event('CastMart.admin.marketing.communications.campaigns.edit.card.accordion.setting.before', ['campaign' => $campaign]) !!}
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.campaigns.edit.card.accordion.setting.after', ['campaign' => $campaign]) !!}

            </div>
        </div>

        {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.create_form_controls.after', ['campaign' => $campaign]) !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.marketing.communications.campaigns.edit.after', ['campaign' => $campaign]) !!}
