<x-admin::layouts>
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('CastMart.admin.marketing.communications.events.list.before') !!}
            ...
            {!! view_render_event('CastMart.admin.marketing.communications.events.list.after') !!}

            {!! view_render_event('CastMart.admin.marketing.communications.events.create.before') !!}
            ...
            >
                ...
                >
                    ...
                    {!! view_render_event('CastMart.admin.marketing.communications.events.create_form_controls.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.communications.events.create_form_controls.after') !!}

                </form>
            </x-admin::form>

            {!! view_render_event('CastMart.admin.marketing.communications.events.create.after') !!}
