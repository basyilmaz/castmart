<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.communications.templates.edit.before', ['template' => $template]) !!}
    <!-- Input Form -->
    <x-admin::form
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.marketing.communications.templates.edit.edit_form_controls.before', ['template' => $template]) !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.templates.edit.card.content.before', ['template' => $template]) !!}
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.templates.edit.card.content.after', ['template' => $template]) !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.templates.edit.card.accordion.general.before', ['template' => $template]) !!}
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.templates.edit.card.accordion.general.after', ['template' => $template]) !!}
    ...
    {!! view_render_event('CastMart.admin.marketing.communications.templates.edit.after', ['template' => $template]) !!}
