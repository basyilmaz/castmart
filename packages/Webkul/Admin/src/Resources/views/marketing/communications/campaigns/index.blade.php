<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.communications.campaigns.list.before') !!}

    <x-admin::datagrid :src="route('admin.marketing.communications.campaigns.index')" />

    {!! view_render_event('CastMart.admin.marketing.communications.campaigns.list.after') !!}
