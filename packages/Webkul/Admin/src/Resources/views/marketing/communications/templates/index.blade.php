<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.communications.templates.list.before') !!}

    <x-admin::datagrid :src="route('admin.marketing.communications.email_templates.index')" />

    {!! view_render_event('CastMart.admin.marketing.communications.templates.list.after') !!}
