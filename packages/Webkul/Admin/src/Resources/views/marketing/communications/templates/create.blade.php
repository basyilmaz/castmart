<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.communications.templates.create.before') !!}

    <!-- Input Form -->
    <x-admin::form :action="route('admin.marketing.communications.email_templates.store')">

        {!! view_render_event('CastMart.admin.marketing.communications.templates.create.create_form_controls.before') !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.templates.create.card.content.before') !!}
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.templates.create.card.content.after') !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                <div class="box-shadow rounded bg-white dark:bg-gray-900">
                    ...
                    {!! view_render_event('CastMart.admin.marketing.communications.templates.create.card.accordion.general.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.marketing.communications.templates.create.card.accordion.general.after') !!}

                </div>
            </div>
        </div>

        {!! view_render_event('CastMart.admin.marketing.communications.templates.create.create_form_controls.after') !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.marketing.communications.templates.create.after') !!}
