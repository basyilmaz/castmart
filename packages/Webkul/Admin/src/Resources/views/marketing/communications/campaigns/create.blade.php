<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.before') !!}

    <!-- Input Form -->
    <x-admin::form :action="route('admin.marketing.communications.campaigns.store')">

        {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.create_form_controls.before') !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.card.general.before') !!}
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.card.general.after') !!}
            </div>

            <!-- Right Section -->
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-md:w-full">

                {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.card.accordion.setting.before') !!}
                ...
                {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.card.accordion.setting.after') !!}
            </div>
        </div>

        {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.create_form_controls.after') !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.marketing.communications.campaigns.create.after') !!}
