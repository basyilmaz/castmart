<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.catalog.categories.create.before') !!}
    ...
    >
        {!! view_render_event('CastMart.admin.catalog.categories.create.create_form_controls.before') !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.create.card.general.before') !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.create.card.general.after') !!}

                {!! view_render_event('CastMart.admin.catalog.categories.create.card.description_images.before') !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.create.card.description_images.after') !!}

                {!! view_render_event('CastMart.admin.catalog.categories.create.card.seo.before') !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.create.card.seo.after') !!}
            </div>
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2">
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.create.card.accordion.settings.before') !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.create.card.accordion.settings.after') !!}

                {!! view_render_event('CastMart.admin.catalog.categories.create.card.accordion.filterable_attributes.before') !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.create.card.accordion.filterable_attributes.after') !!}

            </div>
        </div>

        {!! view_render_event('CastMart.admin.catalog.categories.create.create_form_controls.after') !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.catalog.categories.create.after') !!}
