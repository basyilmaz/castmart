<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.catalog.categories.edit.before', ['category' => $category]) !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.catalog.categories.edit.edit_form_controls.before', ['category' => $category]) !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.general.before', ['category' => $category]) !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.general.after', ['category' => $category]) !!}

                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.description_images.before', ['category' => $category]) !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.description_images.after', ['category' => $category]) !!}

                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.seo.before', ['category' => $category]) !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.seo.after', ['category' => $category]) !!}
            </div>
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2">
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.accordion.settings.before', ['category' => $category]) !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.accordion.settings.after', ['category' => $category]) !!}

                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.accordion.filterable_attributes.before', ['category' => $category]) !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.categories.edit.card.accordion.filterable_attributes.after', ['category' => $category]) !!}
            </div>
        </div>

        {!! view_render_event('CastMart.admin.catalog.categories.edit.edit_form_controls.after', ['category' => $category]) !!}

    </x-admin::form>

    {!! view_render_event('CastMart.admin.catalog.categories.edit.after', ['category' => $category]) !!}
