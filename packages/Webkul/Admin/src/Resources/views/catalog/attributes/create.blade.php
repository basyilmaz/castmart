<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.catalog.attributes.create.before') !!}
    ...
    >
        {!! view_render_event('CastMart.admin.catalog.attributes.create.create_form_controls.before') !!}
        ...
        {!! view_render_event('CastMart.admin.catalog.attributes.create_form_controls.after') !!}
    </x-admin::form>

    {!! view_render_event('CastMart.admin.catalog.attributes.create.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                {!! view_render_event('CastMart.admin.catalog.attributes.create.card.label.before') !!}
                                            ...
                                            <x-admin::table.thead.tr class="hover:bg-gray-50 dark:hover:bg-gray-950">
                                                ...
                                                <x-admin::table.td v-if="showSwatch && (swatchType == 'color' || swatchType == 'image')">
                                                    ...
                                                    <div v-if="swatchType == 'image'">
                                                        <img
                                                            src="{{ CastMart_asset('images/product-placeholders/front.svg') }}"
                ...
                {!! view_render_event('CastMart.admin.catalog.attributes.create.card.label.after') !!}

                {!! view_render_event('CastMart.admin.catalog.attributes.create.card.general.before') !!}
                ...
                {!! view_render_event('CastMart.admin.catalog.attributes.create.card.general.after') !!}
