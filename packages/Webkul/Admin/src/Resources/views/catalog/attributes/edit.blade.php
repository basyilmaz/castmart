<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.catalog.attributes.edit.before', ['attribute' => $attribute]) !!}
    ...
    {!! view_render_event('CastMart.admin.catalog.attributes.edit.after', ['attribute' => $attribute]) !!}
        ...
        >
            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex flex-1 flex-col gap-2 overflow-auto max-xl:flex-auto">
                    ...
                    {!! view_render_event('CastMart.admin.catalog.attributes.edit.card.label.before', ['attribute' => $attribute]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.catalog.attributes.edit.card.label.after', ['attribute' => $attribute]) !!}
                                                ...
                                                >
                                                    ...
                                                    <x-admin::table.td v-if="showSwatch && (swatchType == 'color' || swatchType == 'image')">
                                                        ...
                                                        <div v-if="swatchType == 'image'">
                                                            <img
                                                                :src="element.swatch_value_url || '{{ CastMart_asset('images/product-placeholders/front.svg') }}'"
                            ...
                            <template v-else>
                                <div class="grid justify-items-center gap-3.5 px-2.5 py-10">
                                    ...
                                    <img
                                        ...
                                        src="{{ CastMart_asset('images/icon-add-product.svg') }}"
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    {!! view_render_event('CastMart.admin.catalog.attributes.edit.card.accordion.general.before', ['attribute' => $attribute]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.catalog.attributes.edit.card.accordion.general.after', ['attribute' => $attribute]) !!}

                    {!! view_render_event('CastMart.admin.catalog.attributes.edit.card.accordion.validations.before', ['attribute' => $attribute]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.catalog.attributes.edit.card.accordion.validations.after', ['attribute' => $attribute]) !!}

                    {!! view_render_event('CastMart.admin.catalog.attributes.edit.card.accordion.configuration.before', ['attribute' => $attribute]) !!}
                    ...
                    {!! view_render_event('CastMart.admin.catalog.attributes.edit.card.accordion.configuration.configuration.after', ['attribute' => $attribute]) !!}
                </div>
            </div>
