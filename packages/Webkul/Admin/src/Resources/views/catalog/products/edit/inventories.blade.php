{!! view_render_event('CastMart.admin.catalog.product.edit.form.inventories.controls.before', ['product' => $product]) !!}
...
{!! view_render_event('CastMart.admin.catalog.product.edit.form.inventories.controls.after', ['product' => $product]) !!}
