<x-admin::layouts>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        ...
        <div class="flex items-center gap-x-2.5">
            ...
            {!! view_render_event('CastMart.admin.catalog.products.create.before') !!}
            ...
            {!! view_render_event('CastMart.admin.catalog.products.create.after') !!}
        </div>
    </div>

    {!! view_render_event('CastMart.admin.catalog.products.list.before') !!}
                                ...
                                <div class="relative flex-shrink-0">
                                    ...
                                    <template v-else>
                                        <div class="relative h-12 w-12 rounded border border-dashed border-gray-300 dark:border-gray-800 dark:mix-blend-exclusion dark:invert sm:h-16 sm:w-16">
                                            <img src="{{ CastMart_asset('images/product-placeholders/front.svg')}}" class="h-full w-full object-cover">
    ...
    {!! view_render_event('CastMart.admin.catalog.products.list.after') !!}
                        ...
                        <x-admin::modal ref="productCreateModal">
                            ...
                            <x-slot:content>
                                <div v-show="! attributes.length">
                                    {!! view_render_event('CastMart.admin.catalog.products.create_form.general.controls.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.admin.catalog.products.create_form.general.controls.after') !!}
                                </div>

                                <div v-show="attributes.length">
                                    {!! view_render_event('CastMart.admin.catalog.products.create_form.attributes.controls.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.admin.catalog.products.create_form.attributes.controls.after') !!}
                                </div>
                            </x-slot>
