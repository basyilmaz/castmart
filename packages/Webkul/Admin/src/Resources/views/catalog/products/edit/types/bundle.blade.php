...
{!! view_render_event('CastMart.admin.catalog.product.edit.form.types.bundle.before', ['product' => $product]) !!}

<v-bundle-options :errors="errors"></v-bundle-options>

{!! view_render_event('CastMart.admin.catalog.product.edit.form.types.bundle.after', ['product' => $product]) !!}
    ...
    >
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            >
                <!-- Placeholder Image -->
                <img
                    src="{{ CastMart_asset('images/icon-options.svg') }}"
