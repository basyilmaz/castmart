...
{!! view_render_event('CastMart.admin.catalog.product.edit.form.types.booking.before', ['product' => $product]) !!}

<!-- Vue Component -->
<v-booking-information></v-booking-information>

{!! view_render_event('CastMart.admin.catalog.product.edit.form.types.booking.after', ['product' => $product]) !!}
