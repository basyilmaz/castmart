{!! view_render_event('CastMart.admin.catalog.product.edit.booking.rental.before', ['product' => $product]) !!}

<!-- Vue Component -->
<v-rental-booking></v-rental-booking>

{!! view_render_event('CastMart.admin.catalog.product.edit.booking.rental.after', ['product' => $product]) !!}
