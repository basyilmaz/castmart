{!! view_render_event('CastMart.admin.catalog.product.edit.booking.event.before', ['product' => $product]) !!}

<v-event-booking></v-event-booking>

{!! view_render_event('CastMart.admin.catalog.product.edit.booking.event.after', ['product' => $product]) !!}
