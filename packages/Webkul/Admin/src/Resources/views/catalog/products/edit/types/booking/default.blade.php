{!! view_render_event('CastMart.admin.catalog.product.edit.booking.default.before', ['product' => $product]) !!}

<!-- Vue Component -->
<v-default-booking></v-default-booking>

{!! view_render_event('CastMart.admin.catalog.product.edit.booking.default.after', ['product' => $product]) !!}
