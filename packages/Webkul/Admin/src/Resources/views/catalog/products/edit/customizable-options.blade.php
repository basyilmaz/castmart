@if ($product->getTypeInstance()->isCustomizable())
    ...
    {!! view_render_event('CastMart.admin.catalog.product.edit.form.types.simple.customizable-options.before', ['product' => $product]) !!}

    <v-customizable-options :errors="errors"></v-customizable-options>

    {!! view_render_event('CastMart.admin.catalog.product.edit.form.types.simple.customizable-options.after', ['product' => $product]) !!}
