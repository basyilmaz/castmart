{!! view_render_event('CastMart.admin.catalog.product.edit.booking.table.before', ['product' => $product]) !!}

<!-- Vue Component -->
<v-table-booking></v-table-booking>

{!! view_render_event('CastMart.admin.catalog.product.edit.booking.table.after', ['product' => $product]) !!}
