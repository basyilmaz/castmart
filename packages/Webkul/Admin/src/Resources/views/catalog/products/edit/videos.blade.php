{!! view_render_event('CastMart.admin.catalog.product.edit.form.videos.before', ['product' => $product]) !!}
...
{!! view_render_event('CastMart.admin.catalog.product.edit.form.videos.after', ['product' => $product]) !!}
