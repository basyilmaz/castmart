{!! view_render_event('CastMart.admin.catalog.product.edit.form.links.before', ['product' => $product]) !!}
    
<v-product-links></v-product-links>

{!! view_render_event('CastMart.admin.catalog.product.edit.form.links.after', ['product' => $product]) !!}
