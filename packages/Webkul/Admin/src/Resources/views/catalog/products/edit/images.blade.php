{!! view_render_event('CastMart.admin.catalog.product.edit.form.images.before', ['product' => $product]) !!}
...
{!! view_render_event('CastMart.admin.catalog.product.edit.form.images.after', ['product' => $product]) !!}
