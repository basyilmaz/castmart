{!! view_render_event('CastMart.admin.catalog.product.edit.form.types.downloadable.before', ['product' => $product]) !!}

<v-downloadable-links :errors="errors"></v-downloadable-links>

<v-downloadable-samples :errors="errors"></v-downloadable-samples>

{!! view_render_event('CastMart.admin.catalog.product.edit.form.types.downloadable.after', ['product' => $product]) !!}
