{!! view_render_event('CastMart.admin.catalog.product.edit.form.categories.before', ['product' => $product]) !!}
...
<div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
    ...
    {!! view_render_event('CastMart.admin.catalog.product.edit.form.categories.controls.before', ['product' => $product]) !!}
    ...
    {!! view_render_event('CastMart.admin.catalog.product.edit.form.categories.controls.after', ['product' => $product]) !!}
</div>

{!! view_render_event('CastMart.admin.catalog.product.edit.form.categories.after', ['product' => $product]) !!}
