@if (! $product->parent_id)
    ...
    @else
        {!! view_render_event('CastMart.admin.catalog.product.edit.form.channels.before', ['product' => $product]) !!}
        ...
        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
            ...
            {!! view_render_event('CastMart.admin.catalog.product.edit.form.channels.controls.before', ['product' => $product]) !!}
            ...
            {!! view_render_event('CastMart.admin.catalog.product.edit.form.channels.controls.after', ['product' => $product]) !!}
        </div>

        {!! view_render_event('CastMart.admin.catalog.product.edit.form.channels.after', ['product' => $product]) !!}
    @endif
@endif
