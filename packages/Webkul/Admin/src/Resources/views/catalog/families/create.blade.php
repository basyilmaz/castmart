<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.catalog.families.store')">
        ...
        {!! view_render_event('CastMart.admin.catalog.families.create.create_form_controls.before') !!}
        ...
        {!! view_render_event('CastMart.admin.catalog.families.create.create_form_controls.after') !!}
