...
<head>
    {!! view_render_event('CastMart.admin.layout.head.before') !!}
    ...
    @CastMartVite(['src/Resources/assets/css/app.css', 'src/Resources/assets/js/app.js'])
    ...
    <link
        rel="preload"
        as="image"
        href="{{ url('cache/logo/CastMart.png') }}"
    >
    ...
    @else
        <link
            type="image/x-icon"
            href="{{ CastMart_asset('images/favicon.ico') }}"
            rel="shortcut icon"
            sizes="16x16"
        />
    @endif
    ...
    {!! view_render_event('CastMart.admin.layout.head.after') !!}
</head>

<body class="h-full dark:bg-gray-950">
    {!! view_render_event('CastMart.admin.layout.body.before') !!}
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.layout.content.before') !!}
                ...
                <div class="mt-auto">
                    <div class="border-t bg-white py-2 text-center text-xs sm:text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-white">
                        @lang('admin::app.components.layouts.powered-by.description', [
                            'CastMart' => '<a class="text-blue-600 hover:underline dark:text-darkBlue" href="https://CastMart.com/en/">CastMart</a>',
        ...
        {!! view_render_event('CastMart.admin.layout.content.after') !!}
    </div>

    {!! view_render_event('CastMart.admin.layout.body.after') !!}

    @stack('scripts')

    {!! view_render_event('CastMart.admin.layout.vue-app-mount.before') !!}
    ...
    {!! view_render_event('CastMart.admin.layout.vue-app-mount.after') !!}
</body>
