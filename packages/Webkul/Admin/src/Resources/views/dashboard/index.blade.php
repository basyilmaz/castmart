<x-admin::layouts>
    ...
    <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
        ...
        <div class="flex flex-1 flex-col gap-8 max-xl:flex-auto">
            {!! view_render_event('CastMart.admin.dashboard.overall_details.before') !!}
            ...
            {!! view_render_event('CastMart.admin.dashboard.overall_details.after') !!}

            {!! view_render_event('CastMart.admin.dashboard.todays_details.before') !!}
            ...
            {!! view_render_event('CastMart.admin.dashboard.todays_details.after') !!}

            {!! view_render_event('CastMart.admin.dashboard.stock_threshold.before') !!}
            ...
            {!! view_render_event('CastMart.admin.dashboard.stock_threshold.after') !!}
        </div>
        ...
        <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
            ...
            {!! view_render_event('CastMart.admin.dashboard.store_stats.before') !!}
            ...
            {!! view_render_event('CastMart.admin.dashboard.store_stats.after') !!}
        </div>
    </div>
    ...
    @pushOnce('scripts')
        <script
            type="module"
            src="{{ CastMart_asset('js/chart.js') }}"
        >
        </script>
