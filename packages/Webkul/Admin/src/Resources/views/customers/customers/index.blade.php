<x-admin::layouts>
        ...
        <div class="flex items-center gap-x-2.5">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                @if (bouncer()->hasPermission('customers.customers.create'))
                    {!! view_render_event('CastMart.admin.customers.customers.create.before') !!}
                    ...
                    {!! view_render_event('CastMart.admin.customers.customers.create.after') !!}
    ...
    {!! view_render_event('CastMart.admin.customers.customers.list.before') !!}
    ...
    {!! view_render_event('CastMart.admin.customers.customers.list.after') !!}
</x-admin::layouts>
