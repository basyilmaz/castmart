<x-admin::layouts>
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('CastMart.admin.customers.customers.view.filters.before') !!}
            ...
            {!! view_render_event('CastMart.admin.customers.customers.view.filters.after') !!}

            <!-- Content -->
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                <!-- Left Component -->
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    {!! view_render_event('CastMart.admin.customers.customers.view.card.orders.before') !!}

                    @include('admin::customers.customers.view.orders')

                    {!! view_render_event('CastMart.admin.customers.customers.view.card.orders.after') !!}

                    {!! view_render_event('CastMart.admin.customers.customers.view.card.invoices.before') !!}

                    @include('admin::customers.customers.view.invoices')

                    {!! view_render_event('CastMart.admin.customers.customers.view.card.invoices.after') !!}

                    {!! view_render_event('CastMart.admin.customers.customers.view.card.reviews.before') !!}

                    @include('admin::customers.customers.view.reviews')

                    {!! view_render_event('CastMart.admin.customers.customers.view.card.reviews.after') !!}

                    {!! view_render_event('CastMart.admin.customers.customers.view.card.notes.before') !!}

                    @include('admin::customers.customers.view.notes')

                    {!! view_render_event('CastMart.admin.customers.customers.view.card.notes.after') !!}
                </div>

                <!-- Right Component -->
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">

                    {!! view_render_event('CastMart.admin.customers.customers.view.card.accordion.customer.before') !!}

                    <!-- Information -->
                    {!! view_render_event('CastMart.admin.customers.customers.view.card.accordion.customer.after') !!}
                    ...
                    {!! view_render_event('CastMart.admin.customers.customers.view.card.accordion.address.before') !!}
                            ...
                            <x-slot:content>
                                ...
                                <template v-else>
                                    ...
                                    <div class="flex items-center gap-5 py-2.5">
                                        <img
                                            src="{{ CastMart_asset('images/settings/address.svg') }}"
                    ...
                    {!! view_render_event('CastMart.admin.customers.customers.view.card.accordion.address.after') !!}
                </div>
            </div>
        </script>
