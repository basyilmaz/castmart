...
@pushOnce('scripts')
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.customers.customers.view.edit.edit_form_controls.before', ['customer' => $customer]) !!}
        ...
        >
            ...
            >
                ...
                <x-admin::modal ref="customerEditModal">
                    ...
                    <!-- Modal Content -->
                    <x-slot:content>
                        {!! view_render_event('CastMart.admin.customers.customers.view.edit.before', ['customer' => $customer]) !!}
                        ...
                        {!! view_render_event('CastMart.admin.customers.customers.view.edit.after', ['customer' => $customer]) !!}
                    </x-slot>
        ...
        {!! view_render_event('CastMart.admin.customers.customers.view.edit.edit_form_controls.after', ['customer' => $customer]) !!}
    </script>
