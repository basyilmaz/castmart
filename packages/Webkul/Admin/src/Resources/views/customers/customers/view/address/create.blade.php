...
@pushOnce('scripts')
    ...
    >
        ...
        {!! view_render_event('CastMart.admin.customers.addresses.create.before') !!}
        ...
        >
            <form @submit="handleSubmit($event, create)">
                {!! view_render_event('CastMart.admin.customers.addresses.create.create_form_controls.before') !!}
                ...
                >
                    ...
                    <x-slot:content>
                        ...
                        {!! view_render_event('CastMart.admin.customers.create.after') !!}
                ...
                {!! view_render_event('CastMart.admin.customers.addresses.create.create_form_controls.after') !!}

            </form>
        </x-admin::form>

        {!! view_render_event('CastMart.admin.customers.addresses.create.after') !!}
