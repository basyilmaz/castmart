...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            {!! view_render_event('CastMart.admin.customers.addresses.edit.before') !!}

            <x-admin::form
                v-slot="{ meta, errors, handleSubmit }"
                as="div"
            >
                {!! view_render_event('CastMart.admin.customers.addresses.edit.edit_form_controls.before') !!}
                ...
                >
                    ...
                    >
                        ...
                        <x-slot:content>
                            ...
                            {!! view_render_event('CastMart.admin.customer.addresses.edit.before') !!}
                            ...
                            {!! view_render_event('CastMart.admin.customers.edit.after') !!}
                ...
                {!! view_render_event('CastMart.admin.customers.addresses.edit.edit_form_controls.after') !!}

            </x-admin::form>

            {!! view_render_event('CastMart.admin.customers.addresses.edit.after') !!}
        </div>
    </script>
