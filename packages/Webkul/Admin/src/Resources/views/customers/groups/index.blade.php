<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.customers.groups.create.before') !!}

    <v-create-group />

    {!! view_render_event('CastMart.admin.customers.groups.create.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            <div>
                ...
                {!! view_render_event('CastMart.admin.customers.groups.list.before') !!}
                ...
                {!! view_render_event('CastMart.admin.customers.groups.list.after') !!}
