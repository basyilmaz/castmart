<x-admin::layouts>
    ...
    {!! view_render_event('CastMart.admin.customers.reviews.edit.before') !!}

    <v-review-edit-drawer></v-review-edit-drawer>

    {!! view_render_event('CastMart.admin.customers.groups.edit.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('CastMart.admin.customers.reviews.list.before') !!}
            ...
            {!! view_render_event('CastMart.admin.customers.reviews.list.after') !!}
