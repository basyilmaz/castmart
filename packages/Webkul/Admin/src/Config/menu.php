...
return [
    ...
    [
        'key'        => 'marketplace',
        'name'       => 'Pazaryeri',
        'route'      => 'admin.marketplace.trendyol.dashboard',
        'sort'       => 8,
        'icon'       => 'icon-store',
    ], [
        'key'        => 'marketplace.trendyol',
        'name'       => 'Trendyol',
        'route'      => 'admin.marketplace.trendyol.dashboard',
        'sort'       => 1,
        'icon'       => '',
    ...
    // Ana Sekmeler (8 adet)
    [
        'key'        => 'marketplace.trendyol.dashboard',
        'name'       => '📊 Dashboard',
        'route'      => 'admin.marketplace.trendyol.dashboard',
        'sort'       => 1,
        'icon'       => '',
    ], [
        'key'        => 'marketplace.trendyol.intelligence',
        'name'       => '🧠 7. His',
        'route'      => 'admin.marketplace.trendyol.intelligence',
        'sort'       => 2,
        'icon'       => '',
    ], [
        'key'        => 'marketplace.trendyol.products',
        'name'       => '📦 Ürünler',
        'route'      => 'admin.marketplace.trendyol.products',
        'sort'       => 3,
        'icon'       => '',
    ], [
        'key'        => 'marketplace.trendyol.orders',
        'name'       => '🛒 Siparişler',
        'route'      => 'admin.marketplace.trendyol.orders',
        'sort'       => 4,
        'icon'       => '',
    ], [
        'key'        => 'marketplace.trendyol.commission-calculator',
        'name'       => '🧮 Hesaplayıcı',
        'route'      => 'admin.marketplace.trendyol.commission-calculator',
        'sort'       => 5,
        'icon'       => '',
    ], [
        'key'        => 'marketplace.trendyol.buybox-tracker',
        'name'       => '🎯 BuyBox',
        'route'      => 'admin.marketplace.trendyol.buybox-tracker',
        'sort'       => 6,
        'icon'       => '',
    ], [
        'key'        => 'marketplace.trendyol.accounts',
        'name'       => '⚙️ Hesaplar',
        'route'      => 'admin.marketplace.trendyol.accounts',
        'sort'       => 7,
        'icon'       => '',
    ], [
        'key'        => 'marketplace.trendyol.notifications',
        'name'       => '🔔',
        'route'      => 'admin.marketplace.trendyol.notifications',
        'sort'       => 8,
        'icon'       => '',
    ],
