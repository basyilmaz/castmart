...
>
    <head>
        ...
        @CastMartVite(['src/Resources/assets/css/app.css', 'src/Resources/assets/js/app.js'], 'installer')
        ...
        <link
            type="image/x-icon"
            href="{{ CastMart_asset('images/installer/favicon.ico', 'installer') }}"
            rel="shortcut icon"
            sizes="16x16"
        />
        ...
        @pushOnce('scripts')
            ...
            >
                ...
                <div class="flex flex-col justify-center">
                    <div class="m-auto grid h-[100vh] max-w-[362px] items-end">
                        <div class="grid gap-4">
                            <img
                                src="{{ CastMart_asset('images/installer/CastMart-logo.svg', 'installer') }}"
                                alt="@lang('installer::app.installer.index.CastMart-logo')"
                            >
                        ...
                        <p class="mb-6 w-full place-self-end text-left">
                            <a
                                ...
                                href="https://CastMart.com/en/"
                            >
                                @lang('installer::app.installer.index.CastMart')
                            </a>

                            <span>@lang('installer::app.installer.index.CastMart-info')</span>
                    ...
                    <div class="flex h-[484px] flex-col justify-center gap-4 overflow-y-auto px-7 py-4">
                        <div class="flex flex-col gap-4">
                            <p class="text-lg font-bold text-gray-800">
                                @lang('installer::app.installer.index.installation-processing.CastMart')
                            </p>
                            ...
                            <div class="grid gap-2.5">
                                ...
                                <img
                                    ...
                                    src="{{ CastMart_asset('images/installer/spinner.svg', 'installer') }}"
                                    alt="Loading"
                                />

                                <p class="text-sm text-gray-600">
                                    @lang('installer::app.installer.index.installation-processing.CastMart-info')
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        type="text"
                                        name="app_name"
                                        ::value="envData.app_name ?? 'CastMart'"
                                        rules="required"
                                        :label="trans('installer::app.installer.index.environment-configuration.application-name')"
                                        :placeholder="trans('installer::app.installer.index.environment-configuration.CastMart')"
                                    />
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        ...
                                        :placeholder="trans('installer::app.installer.index.create-administrator.CastMart')"
                                    />
                ...
                >
                    ...
                    <div class="flex items-center justify-between px-4 py-2.5">
                        <a
                            href="https://forums.CastMart.com"
                            class="cursor-pointer text-xs font-semibold text-blue-600"
                        >
                            @lang('installer::app.installer.index.installation-completed.CastMart-forums')
                        </a>

                        <a
                            href="https://CastMart.com/en/extensions"
                            class="cursor-pointer rounded-md border border-blue-700 bg-white px-3 py-1.5 font-semibold text-blue-600 hover:opacity-90"
                        >
                            @lang('installer::app.installer.index.installation-completed.explore-CastMart-extensions')
                        </a>
                    </div>
                </div>
            </script>
                            ...
                            const stepActions = {
                                envDatabase: () => {
                                    if (params.db_connection === 'mysql') {
                                        ...
                                        setErrors({ 'db_connection': ["CastMart currently supports MySQL only."] });
                                    }
                                },
