    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'CastMart'          => 'Instalação do CastMart',
                'CastMart-info'     => 'A criação de tabelas no banco de dados pode levar alguns momentos',
                'title'            => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Painel de Administração',
                'CastMart-forums'             => 'Fórum CastMart',
                'customer-panel'             => 'Painel do Cliente',
                'explore-CastMart-extensions' => 'Explorar Extensões CastMart',
                'title'                      => 'Instalação Concluída',
                'title-info'                 => 'O CastMart foi instalado com sucesso no seu sistema.',
            ],
            ...
            'back'                     => 'Wstecz',
            'CastMart'                  => 'CastMart',
            'CastMart-info'             => 'Projekt społecznościowy',
            ...
            'installation-description' => 'A instalação do CastMart geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do CastMart',
