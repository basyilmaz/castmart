    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'CastMart'          => 'Installazione CastMart',
                'CastMart-info'     => 'Creazione delle tabelle del Database, questo potrebbe richiedere qualche momento',
                'title'            => 'Installazione',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Pannello di Amministrazione',
                'CastMart-forums'             => 'Forum di CastMart',
                'customer-panel'             => 'Pannello del Cliente',
                'explore-CastMart-extensions' => 'Esplora le Estensioni di CastMart',
                'title'                      => 'Installazione Completata',
                'title-info'                 => 'CastMart è stato installato con successo sul tuo sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => 'Crea la tabella del database',
                'install'                 => 'Installazione',
                'install-info'            => 'CastMart per l\'installazione',
            ...
            'start' => [
                ...
                'title'         => 'La tua installazione di CastMart',
                'welcome-title' => 'Benvenuto in CastMart',
            ],
            ...
            'back'                     => 'Indietro',
            'CastMart'                  => 'CastMart',
            'CastMart-info'             => 'Un progetto della comunità di',
            'CastMart-logo'             => 'Logo CastMart',
            'bengali'                  => 'Bengalese',
            'catalan'                  => 'Catalano',
            'chinese'                  => 'Cinese',
            'continue'                 => 'Continua',
            ...
            'installation-description' => 'L\'installazione di CastMart generalmente prevede diversi passaggi. Ecco una panoramica generale del processo di installazione per CastMart',
            ...
            'sinhala'                  => 'Singalese',
            'spanish'                  => 'Spagnolo',
            'title'                    => 'Installazione di CastMart',
            'turkish'                  => 'Turco',
            'ukrainian'                => 'Ucraino',
            'webkul'                   => 'Webkul',
        ],
