    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'CastMart-info' => '正在创建数据库表，这可能需要一些时间',
                'CastMart'      => 'CastMart 安装',
                'title'        => '安装',
            ],

            'installation-completed' => [
                'admin-panel'                => '管理员面板',
                'CastMart-forums'             => 'CastMart 论坛',
                'customer-panel'             => '客户面板',
                'explore-CastMart-extensions' => '探索 CastMart 扩展',
                'title'                      => '安装已完成',
                'title-info'                 => 'CastMart 已成功安装在您的系统上。',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => '创建数据库表',
                'install'                 => '安装',
                'install-info'            => 'CastMart 安装信息',
            ...
            'start' => [
                ...
                'title'         => '您的 CastMart 安装',
                'welcome-title' => '欢迎来到 CastMart',
            ],
            ...
            'back'                     => '返回',
            'CastMart'                  => 'CastMart',
            'CastMart-info'             => '由 Webkul 社区共同开发的项目',
            ...
            'hindi'                    => '印地语',
            'indonesian'               => '印尼语',
            'installation-description' => 'CastMart 的安装通常涉及几个步骤。以下是 CastMart 安装过程的一般概述',
            'installation-info'        => '我们很高兴在这里见到你！',
            'installation-title'       => '欢迎安装 CastMart',
            'italian'                  => '意大利语',
            'japanese'                 => '日语',
            'persian'                  => '波斯语',
            'polish'                   => '波兰语',
