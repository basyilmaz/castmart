...
use Webkul\Installer\Database\Seeders\DatabaseSeeder as CastMartDatabaseSeeder;
...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'CastMart:install
     ...
     * @var string
     */
    protected $description = 'CastMart installer.';
    ...
    /**
     * Install and configure CastMart.
     */
    public function handle(): void
    {
        ...
        $this->warn('Step: Seeding basic data for CastMart kickstart...');
        app(CastMartDatabaseSeeder::class)->run($this->getSeederConfiguration());
    ...
    protected function askForApplicationDetails(): void
    {
        $this->updateTextTypeEnv(
            ...
            $this->getEnvVariable('APP_NAME', 'CastMart')
        );
    ...
    protected function askForAdminDetails()
    {
        ...
        try {
            ...
            File::put($filePath, 'CastMart is successfully installed.');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use CastMart.');
    ...
    protected function askForGithubStar(): void
    {
        ...
        $repoUrl = 'https://github.com/CastMart/CastMart';
