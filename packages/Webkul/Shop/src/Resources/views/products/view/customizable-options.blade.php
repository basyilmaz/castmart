@if ($product->getTypeInstance()->isCustomizable())
    ...
    @if ($options->isNotEmpty())
        {!! view_render_event('CastMart.shop.products.view.customizable-options.before', ['product' => $product]) !!}
        ...
        {!! view_render_event('CastMart.shop.products.view.customizable-options.after', ['product' => $product]) !!}
