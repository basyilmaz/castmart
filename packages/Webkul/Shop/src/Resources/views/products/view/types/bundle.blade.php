@if ($product->type == 'bundle')
    {!! view_render_event('CastMart.shop.products.view.bundle-options.before', ['product' => $product]) !!}

    <v-product-bundle-options :errors="errors"></v-product-bundle-options>

    {!! view_render_event('CastMart.shop.products.view.bundle-options.after', ['product' => $product]) !!}
