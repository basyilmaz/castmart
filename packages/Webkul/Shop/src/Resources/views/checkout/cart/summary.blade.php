<div class="w-[418px] max-w-full max-md:w-full">
    {!! view_render_event('CastMart.shop.checkout.cart.summary.title.before') !!}
    ...
    {!! view_render_event('CastMart.shop.checkout.cart.summary.title.after') !!}
    ...
    <div class="mt-6 grid gap-4 max-md:mt-2 max-md:gap-2.5">
        ...
        <!-- Sub Total -->
        {!! view_render_event('CastMart.shop.checkout.cart.summary.sub_total.before') !!}
        ...
        {!! view_render_event('CastMart.shop.checkout.cart.summary.sub_total.after') !!}

        <!-- Discount -->
        {!! view_render_event('CastMart.shop.checkout.cart.summary.discount_amount.before') !!}
        ...
        {!! view_render_event('CastMart.shop.checkout.cart.summary.discount_amount.after') !!}

        <!-- Apply Coupon -->
        {!! view_render_event('CastMart.shop.checkout.cart.summary.coupon.before') !!}
        
        @include('shop::checkout.coupon')

        {!! view_render_event('CastMart.shop.checkout.cart.summary.coupon.after') !!}
        ...
        <!-- Taxes -->
        {!! view_render_event('CastMart.shop.checkout.cart.summary.tax.before') !!}
        ...
        {!! view_render_event('CastMart.shop.checkout.cart.summary.tax.after') !!}
   
        <!-- Cart Grand Total -->
        {!! view_render_event('CastMart.shop.checkout.cart.summary.grand_total.before') !!}
        ...
        {!! view_render_event('CastMart.shop.checkout.cart.summary.grand_total.after') !!}

        {!! view_render_event('CastMart.shop.checkout.cart.summary.proceed_to_checkout.before') !!}
        ...
        {!! view_render_event('CastMart.shop.checkout.cart.summary.proceed_to_checkout.after') !!}
    </div>
</div>
