...
@pushOnce('scripts')
    ...
    >
        {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.before') !!}

        @if (core()->getConfigData('sales.checkout.mini_cart.display_mini_cart'))
            <x-shop::drawer>
                <!-- Drawer Toggler -->
                <x-slot:toggle>
                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.toggle.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.toggle.after') !!}
                </x-slot>

                <!-- Drawer Header -->
                <x-slot:header>
                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.header.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.header.after') !!}
                </x-slot>

                <!-- Drawer Content -->
                <x-slot:content>
                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.before') !!}
                    ...
                    >
                        ...
                        >
                            <!-- Cart Item Image -->
                            {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.image.before') !!}
                            ...
                            {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.image.after') !!}
                        ...
                        <div class="grid flex-1 place-content-start justify-stretch gap-y-2.5">
                            <div class="flex justify-between gap-2 max-md:gap-0 max-sm:flex-wrap">
                                    ...
                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.name.before') !!}
                                ...
                                >
                                    ...
                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.name.after') !!}

                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.price.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.price.after') !!}
                                </div>
                                ...
                                >
                                    ...
                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.product_details.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.product_details.after') !!}
                                </div>

                                <div class="flex flex-wrap items-center gap-5 max-md:gap-2.5">
                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.quantity_changer.before') !!}
                                ...
                                />
                                    ...
                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.quantity_changer.after') !!}

                                {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.remove_button.before') !!}
                                ...
                                >
                                    ...
                                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.remove_button.after') !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.content.after') !!}
                </x-slot>
            ...
            <x-slot:footer>
                ...
                >
                    ...
                    >
                        {!! view_render_event('CastMart.shop.checkout.mini-cart.subtotal.before') !!}
                        ...
                        <template v-else>
                            ...
                            {!! view_render_event('CastMart.shop.checkout.mini-cart.subtotal.after') !!}
                        </div>

                        {!! view_render_event('CastMart.shop.checkout.mini-cart.action.before') !!}

                        <!-- Cart Action Container -->
                        <div class="grid gap-2.5 px-6 max-md:px-4 max-sm:gap-1.5">
                            {!! view_render_event('CastMart.shop.checkout.mini-cart.continue_to_checkout.before') !!}
                        ...
                        >
                            ...
                            {!! view_render_event('CastMart.shop.checkout.mini-cart.continue_to_checkout.after') !!}
                        ...
                        {!! view_render_event('CastMart.shop.checkout.mini-cart.action.after') !!}
                    </div>
                </x-slot>
            </x-shop::drawer>
        ...
        {!! view_render_event('CastMart.shop.checkout.mini-cart.drawer.after') !!}
    </script>
