...
{!! view_render_event('CastMart.shop.checkout.cart.summary.estimate_shipping.before') !!}
...
{!! view_render_event('CastMart.shop.checkout.cart.summary.estimate_shipping.after') !!}
            ...
            <form @change="handleSubmit($event, estimateShipping)">
                ...
                >
                    <template v-for="method in methods">
                        {!! view_render_event('CastMart.shop.checkout.cart.summary.estimate_shipping.shipping_method.before') !!}
                        ...
                        {!! view_render_event('CastMart.shop.checkout.cart.summary.estimate_shipping.shipping_method.after') !!}
                    </template>
                </div>
            </form>                    
        </x-shop::form>
