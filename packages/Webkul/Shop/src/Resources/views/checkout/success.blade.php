...
>
	...
	<div class="container mt-8 px-[60px] max-lg:px-8">
		<div class="grid place-items-center gap-y-5 max-md:gap-y-2.5">
			{{ view_render_event('CastMart.shop.checkout.success.image.before', ['order' => $order]) }}
			...
			{{ view_render_event('CastMart.shop.checkout.success.image.after', ['order' => $order]) }}
			...
			{{ view_render_event('CastMart.shop.checkout.success.continue-shopping.before', ['order' => $order]) }}
			...
			{{ view_render_event('CastMart.shop.checkout.success.continue-shopping.after', ['order' => $order]) }}
		</div>
	</div>
</x-shop::layouts>
