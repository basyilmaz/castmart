...
>
    ...
    {!! view_render_event('CastMart.shop.checkout.onepage.header.before') !!}
        ...
        <div class="flex w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] py-4 max-lg:px-8 max-sm:px-4">
            <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
                <a
                    ...
                    aria-label="@lang('shop::checkout.onepage.index.CastMart')"
                >
                    <img
    ...
    {!! view_render_event('CastMart.shop.checkout.onepage.header.after') !!}

    <!-- Page Content -->
    <div class="container px-[60px] max-lg:px-8 max-sm:px-4">

        {!! view_render_event('CastMart.shop.checkout.onepage.breadcrumbs.before') !!}
        ...
        {!! view_render_event('CastMart.shop.checkout.onepage.breadcrumbs.after') !!}
                    ...
                    <div class="sticky top-8 block h-max w-[442px] max-w-full max-lg:w-auto max-lg:max-w-[442px] ltr:pl-8 max-lg:ltr:pl-0 rtl:pr-8 max-lg:rtl:pr-0">
                        ...
                        >
                            <template v-if="cart.payment_method == 'paypal_smart_button'">
                                {!! view_render_event('CastMart.shop.checkout.onepage.summary.paypal_smart_button.before') !!}

                                <!-- Paypal Smart Button Vue Component -->
                                <v-paypal-smart-button></v-paypal-smart-button>

                                {!! view_render_event('CastMart.shop.checkout.onepage.summary.paypal_smart_button.after') !!}
                            </template>
