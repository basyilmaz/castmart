{!! view_render_event('CastMart.shop.checkout.onepage.shipping_methods.before') !!}
...
{!! view_render_event('CastMart.shop.checkout.onepage.shipping_methods.after') !!}
                    ...
                    <x-slot:content class="mt-8 !p-0 max-md:mt-0 max-md:rounded-t-none max-md:border max-md:border-t-0 max-md:!p-4">
                        <div class="flex flex-wrap gap-8 max-md:gap-4 max-sm:gap-2.5">
                            <template v-for="method in methods">
                                {!! view_render_event('CastMart.shop.checkout.onepage.shipping_method.before') !!}
                                ...
                                {!! view_render_event('CastMart.shop.checkout.onepage.shipping_method.after') !!}
                            </template>
                        </div>
                    </x-slot>
                </x-shop::accordion>
