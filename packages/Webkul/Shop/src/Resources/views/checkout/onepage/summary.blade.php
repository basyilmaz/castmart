...
<div class="mt-10 grid border-b border-zinc-200 max-md:mt-3 max-sm:mt-0">
    ...
    >
        {!! view_render_event('CastMart.shop.checkout.onepage.summary.item_image.before') !!}
        ...
        {!! view_render_event('CastMart.shop.checkout.onepage.summary.item_image.after') !!}

        <div>
            {!! view_render_event('CastMart.shop.checkout.onepage.summary.item_name.before') !!}

            <p class="text-base text-navyBlue max-md:text-sm max-md:font-medium">
                @{{ item.name }}
            </p>

            {!! view_render_event('CastMart.shop.checkout.onepage.summary.item_name.after') !!}
...
<div class="mb-8 mt-6 grid gap-4 max-md:mb-0 max-sm:mt-4 max-sm:gap-2.5">
    <!-- Sub Total -->
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.sub_total.before') !!}
    ...
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.sub_total.after') !!}

    <!-- Discount -->
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.discount_amount.before') !!}
    ...
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.discount_amount.after') !!}

    <!-- Apply Coupon -->
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.coupon.before') !!}

    @include('shop::checkout.coupon')

    {!! view_render_event('CastMart.shop.checkout.onepage.summary.coupon.after') !!}

    <!-- Shipping Rates -->
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.delivery_charges.before') !!}
    ...
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.delivery_charges.after') !!}


    <!-- Taxes -->
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.tax.before') !!}
    ...
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.tax.after') !!}

    <!-- Cart Grand Total -->
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.grand_total.before') !!}
    ...
    {!! view_render_event('CastMart.shop.checkout.onepage.summary.grand_total.after') !!}
</div>
