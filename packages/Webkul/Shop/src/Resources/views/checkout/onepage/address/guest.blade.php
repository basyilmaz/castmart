{!! view_render_event('CastMart.shop.checkout.onepage.address.guest.before') !!}
...
{!! view_render_event('CastMart.shop.checkout.onepage.address.guest.after') !!}
    ...
    >
        ...
        >
            <form @submit="handleSubmit($event, addAddress)">
                ...
                <div class="mb-4">
                    {!! view_render_event('CastMart.shop.checkout.onepage.address.guest.billing.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.checkout.onepage.address.guest.billing.after') !!}
                </div>
                ...
                <template v-if="cart.have_stockable_items">
                    ...
                    >
                        {!! view_render_event('CastMart.shop.checkout.onepage.address.guest.shipping.before') !!}
                        ...
                        {!! view_render_event('CastMart.shop.checkout.onepage.address.guest.shipping.after') !!}
                    </div>
                </template>
