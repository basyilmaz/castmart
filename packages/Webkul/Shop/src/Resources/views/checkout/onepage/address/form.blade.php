@pushOnce('scripts')
    ...
    >
        <div class="mt-2 max-md:mt-3">
            ...
            {!! view_render_event('CastMart.shop.checkout.onepage.address.form.company_name.after') !!}
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                ...
                {!! view_render_event('CastMart.shop.checkout.onepage.address.form.first_name.after') !!}
                ...
                {!! view_render_event('CastMart.shop.checkout.onepage.address.form.last_name.after') !!}
            </div>
            ...
            {!! view_render_event('CastMart.shop.checkout.onepage.address.form.email.after') !!}
            ...
            <template v-if="controlName=='billing'">
                ...
                {!! view_render_event('CastMart.shop.checkout.onepage.address.form.vat_id.after') !!}
            </template>
            ...
            {!! view_render_event('CastMart.shop.checkout.onepage.address.form.address.after') !!}
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                ...
                {!! view_render_event('CastMart.shop.checkout.onepage.address.form.country.after') !!}
                ...
                {!! view_render_event('CastMart.shop.checkout.onepage.address.form.state.after') !!}
            </div>
            ...
            <div class="grid grid-cols-2 gap-x-5 max-md:grid-cols-1">
                ...
                {!! view_render_event('CastMart.shop.checkout.onepage.address.form.city.after') !!}
                ...
                {!! view_render_event('CastMart.shop.checkout.onepage.address.form.postcode.after') !!}
            </div>
            ...
            {!! view_render_event('CastMart.shop.checkout.onepage.address.form.phone.after') !!}
        </div>
    </script>
