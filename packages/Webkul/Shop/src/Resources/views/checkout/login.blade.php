    ...
    >
        <div>
            ...
            <x-shop::form
                ...
                as="div"
            >
                {!! view_render_event('CastMart.shop.checkout.login.before') !!}

                <!-- Login form -->
                <form @submit="handleSubmit($event, login)">
                    {!! view_render_event('CastMart.shop.checkout.login.form_controls.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.checkout.login.form_controls.after') !!}
                </form>
            </x-shop::form>

            {!! view_render_event('CastMart.shop.checkout.login.after') !!}
        </div>
    </script>
