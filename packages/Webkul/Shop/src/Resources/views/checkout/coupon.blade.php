...
@pushOnce('scripts')
    ...
    >
        <div class="flex justify-between text-right">
            ...
            {!! view_render_event('CastMart.shop.checkout.cart.coupon.before') !!}
            ...
            <p class="text-base font-medium max-sm:text-sm">
                ...
                >
                    ...
                    <form @submit="handleSubmit($event, applyCoupon)">
                        {!! view_render_event('CastMart.shop.checkout.cart.coupon.coupon_form_controls.before') !!}
                        ...
                        {!! view_render_event('CastMart.shop.checkout.cart.coupon.coupon_form_controls.after') !!}
                    </form>
                </x-shop::form>
            ...
            {!! view_render_event('CastMart.shop.checkout.cart.coupon.after') !!}
        </div>
    </script>
