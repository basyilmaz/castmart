{!! view_render_event('CastMart.shop.categories.view.toolbar.before') !!}

<v-toolbar @filter-applied='setFilters("toolbar", $event)'></v-toolbar>

{!! view_render_event('CastMart.shop.categories.view.toolbar.after') !!}
    ...
    >
        <div>
            ...
            <div class="flex justify-between max-md:hidden">
                {!! view_render_event('CastMart.shop.categories.toolbar.filter.before') !!}
                ...
                {!! view_render_event('CastMart.shop.categories.toolbar.filter.after') !!}

                {!! view_render_event('CastMart.shop.categories.toolbar.pagination.before') !!}
                ...
                {!! view_render_event('CastMart.shop.categories.toolbar.pagination.after') !!}
            </div>
