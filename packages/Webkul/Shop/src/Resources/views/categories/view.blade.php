...
<x-shop::layouts>
    ...
    {!! view_render_event('CastMart.shop.categories.view.banner_path.before') !!}
    ...
    {!! view_render_event('CastMart.shop.categories.view.banner_path.after') !!}

    {!! view_render_event('CastMart.shop.categories.view.description.before') !!}
    ...
    {!! view_render_event('CastMart.shop.categories.view.description.after') !!}
                ...
                <div class="flex items-start gap-10 max-lg:gap-5 md:mt-10">
                    ...
                    <div class="flex-1">
                        ...
                        >
                            ...
                            {!! view_render_event('CastMart.shop.categories.view.list.product_card.before') !!}
                            ...
                            {!! view_render_event('CastMart.shop.categories.view.list.product_card.after') !!}
                        </div>
                        ...
                        <div v-else class="mt-8 max-md:mt-5">
                            ...
                            {!! view_render_event('CastMart.shop.categories.view.grid.product_card.before') !!}
                            ...
                            {!! view_render_event('CastMart.shop.categories.view.grid.product_card.after') !!}
                        </div>

                        {!! view_render_event('CastMart.shop.categories.view.load_more_button.before') !!}
                        ...
                        >
                            ...
                            <img
                                ...
                                src="{{ CastMart_asset('images/spinner.svg') }}"
                                alt="Loading"
                            />
                        </button>

                        {!! view_render_event('CastMart.shop.categories.view.grid.load_more_button.after') !!}
                    </div>
                </div>
            </div>
        </script>
