{!! view_render_event('CastMart.shop.components.layouts.header.desktop.top.before') !!}
...
{!! view_render_event('CastMart.shop.components.layouts.header.desktop.top.after') !!}
...
@pushOnce('scripts')
    ...
    >
        <div class="flex w-full items-center justify-between border border-b border-l-0 border-r-0 border-t-0 px-16">
            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.top.currency_switcher.before') !!}
            ...
            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.top.currency_switcher.after') !!}
            ...
            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.top.locale_switcher.before') !!}
            ...
            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.top.locale_switcher.after') !!}
        </div>
    </script>
    ...
    >
        <div class="my-2.5 grid gap-1 overflow-auto max-md:my-0 sm:max-h-[500px]">
            ...
            >
                <img
                    :src="locale.logo_url || '{{ CastMart_asset('images/default-language.svg') }}'"
                    width="24"
                    height="16"
                />
