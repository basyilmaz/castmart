{!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.before') !!}
...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5">
        {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.logo.before') !!}

        <a
            href="{{ route('shop.home.index') }}"
            aria-label="@lang('shop::app.components.layouts.header.desktop.bottom.CastMart')"
        >
            <img
        ...
        {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.logo.after') !!}

        {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.category.before') !!}
        ...
        {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.category.after') !!}
    </div>

    <!-- Right Nagivation Section -->
    <div class="flex items-center gap-x-9 max-[1100px]:gap-x-6 max-lg:gap-x-8">

        {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.search_bar.before') !!}
        ...
        {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.search_bar.after') !!}

        <!-- Right Navigation Links -->
        <div class="mt-1.5 flex gap-x-8 max-[1100px]:gap-x-6 max-lg:gap-x-8">

            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.compare.before') !!}
            ...
            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.compare.after') !!}

            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.mini_cart.before') !!}
            ...
            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.mini_cart.after') !!}

            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.profile.before') !!}
            ...
            <x-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
                ...
                @guest('customer')
                    <x-slot:content>
                        ...
                        {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.customers_action.before') !!}

                        <div class="mt-6 flex gap-4">
                            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.sign_in_button.before') !!}
                            ...
                            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.sign_up_button.after') !!}
                        </div>

                        {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.customers_action.after') !!}
                    </x-slot>
                @endguest
                ...
                @auth('customer')
                    <x-slot:content class="!p-0">
                        ...
                        <div class="mt-2.5 grid gap-1 pb-2.5">
                            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.profile_dropdown.links.before') !!}
                            ...
                            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.profile_dropdown.links.after') !!}
                        </div>
                    </x-slot>
                @endauth
            </x-shop::dropdown>

            {!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.profile.after') !!}
        </div>
    </div>
</div>
...
@endPushOnce
{!! view_render_event('CastMart.shop.components.layouts.header.desktop.bottom.after') !!}
