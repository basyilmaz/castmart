{!! view_render_event('CastMart.shop.layout.footer.before') !!}
...
<footer class="mt-9 bg-lightOrange max-sm:mt-10">
    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        ...
        {!! view_render_event('CastMart.shop.layout.footer.newsletter_subscription.before') !!}
        ...
        {!! view_render_event('CastMart.shop.layout.footer.newsletter_subscription.after') !!}
    </div>

    <div class="flex justify-between bg-[#F1EADF] px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
        {!! view_render_event('CastMart.shop.layout.footer.footer_text.before') !!}

        <p class="text-sm text-zinc-600 max-md:text-center">
            @lang('shop::app.components.layouts.footer.footer-text', ['current_year'=> date('Y') ])
        </p>

        {!! view_render_event('CastMart.shop.layout.footer.footer_text.after') !!}
    </div>
</footer>

{!! view_render_event('CastMart.shop.layout.footer.after') !!}
