...
<div class="flex flex-wrap gap-4 px-4 pb-4 pt-6 shadow-sm lg:hidden">
    <div class="flex w-full items-center justify-between">
        ...
        <div class="flex items-center gap-x-1.5">
            {!! view_render_event('CastMart.shop.components.layouts.header.mobile.drawer.before') !!}

            <!-- Drawer -->
            <v-mobile-drawer></v-mobile-drawer>

            {!! view_render_event('CastMart.shop.components.layouts.header.mobile.drawer.after') !!}

            {!! view_render_event('CastMart.shop.components.layouts.header.mobile.logo.before') !!}

            <a
                href="{{ route('shop.home.index') }}"
                class="max-h-[30px]"
                aria-label="@lang('shop::app.components.layouts.header.mobile.CastMart')"
            >
                <img
            ...
            {!! view_render_event('CastMart.shop.components.layouts.header.mobile.logo.after') !!}
        </div>

        <!-- Right Navigation -->
        <div>
            <div class="flex items-center gap-x-5 max-md:gap-x-4">
                {!! view_render_event('CastMart.shop.components.layouts.header.mobile.compare.before') !!}
                ...
                {!! view_render_event('CastMart.shop.components.layouts.header.mobile.compare.after') !!}

                {!! view_render_event('CastMart.shop.components.layouts.header.mobile.mini_cart.before') !!}

                @if(core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                    @include('shop::checkout.cart.mini-cart')
                @endif

                {!! view_render_event('CastMart.shop.components.layouts.header.mobile.mini_cart.after') !!}
                    ...
                    <x-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
                        ...
                        @guest('customer')
                            <x-slot:content>
                                ...
                                {!! view_render_event('CastMart.shop.components.layouts.header.mobile.index.customers_action.before') !!}

                                <div class="mt-6 flex gap-4">
                                    {!! view_render_event('CastMart.shop.components.layouts.header.mobile.index.sign_in_button.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.shop.components.layouts.header.mobile.index.sign_in_button.after') !!}
                                </div>

                                {!! view_render_event('CastMart.shop.components.layouts.header.mobile.index.customers_action.after') !!}
                            </x-slot>
                        @endguest
                        ...
                        @auth('customer')
                            <x-slot:content class="!p-0">
                                ...
                                <div class="mt-2.5 grid gap-1 pb-2.5">
                                    {!! view_render_event('CastMart.shop.components.layouts.header.mobile.index.profile_dropdown.links.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.shop.components.layouts.header.mobile.index.profile_dropdown.links.after') !!}
                                </div>
                            </x-slot>
                        @endauth
                    </x-shop::dropdown>
    ...
    {!! view_render_event('CastMart.shop.components.layouts.header.mobile.search.before') !!}
    ...
    {!! view_render_event('CastMart.shop.components.layouts.header.mobile.search.after') !!}
</div>
            ...
            <x-slot:content class="!p-0">
                ...
                <div class="border-b border-zinc-200 p-4">
                    <div class="grid grid-cols-[auto_1fr] items-center gap-4 rounded-xl border border-zinc-200 p-2.5">
                        <div>
                            <img
                                src="{{ auth()->user()?->image_url ??  CastMart_asset('images/user-placeholder.png') }}"
                ...
                {!! view_render_event('CastMart.shop.components.layouts.header.mobile.drawer.categories.before') !!}

                <!-- Mobile category view -->
                <v-mobile-category ref="mobileCategory"></v-mobile-category>

                {!! view_render_event('CastMart.shop.components.layouts.header.mobile.drawer.categories.after') !!}
            </x-slot>
                                ...
                                >
                                    <img
                                        src="{{ ! empty(core()->getCurrentLocale()->logo_url)
                                                ...
                                                : CastMart_asset('images/default-language.svg')
                                            }}"
                                        class="h-full"
                                        alt="Default locale"
                                        width="24"
