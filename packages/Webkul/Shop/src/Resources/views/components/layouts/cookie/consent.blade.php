<x-shop::layouts>
    ...
    {!! view_render_event('CastMart.shop.settings.gdpr.consent.before') !!}

    <v-cookie-consent ref="cookie-consent"></v-cookie-consent>

    {!! view_render_event('CastMart.shop.settings.gdpr.consent.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            {!! view_render_event('CastMart.shop.settings.gdpr.consent.form.before') !!}
            ...
            {!! view_render_event('CastMart.shop.settings.gdpr.consent.form.after') !!}
        </script>
