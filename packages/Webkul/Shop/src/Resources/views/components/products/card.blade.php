    ...
    >
        ...
        >
            <div class="relative max-h-[300px] max-w-[291px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-lg max-sm:max-h-[200px] max-sm:max-w-full">
                {!! view_render_event('CastMart.shop.components.products.card.image.before') !!}
                ...
                {!! view_render_event('CastMart.shop.components.products.card.image.after') !!}

                <!-- Product Ratings -->
                {!! view_render_event('CastMart.shop.components.products.card.average_ratings.before') !!}
                ...
                {!! view_render_event('CastMart.shop.components.products.card.average_ratings.after') !!}
                ...
                <div class="action-items bg-black">
                    ...
                    <div class="opacity-0 transition-all duration-300 group-hover:bottom-0 group-hover:opacity-100 max-lg:opacity-100 max-sm:opacity-100">
                        ...
                        {!! view_render_event('CastMart.shop.components.products.card.wishlist_option.before') !!}
                        ...
                        {!! view_render_event('CastMart.shop.components.products.card.wishlist_option.after') !!}

                        {!! view_render_event('CastMart.shop.components.products.card.compare_option.before') !!}
                        ...
                        {!! view_render_event('CastMart.shop.components.products.card.compare_option.after') !!}
            ...
            <div class="-mt-9 grid max-w-[291px] translate-y-9 content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:translate-y-0 max-md:gap-0 max-md:px-0 max-md:py-1.5 max-sm:min-w-[170px] max-sm:max-w-[192px]">
                ...
                {!! view_render_event('CastMart.shop.components.products.card.name.before') !!}
                ...
                {!! view_render_event('CastMart.shop.components.products.card.name.after') !!}

                <!-- Pricing -->
                {!! view_render_event('CastMart.shop.components.products.card.price.before') !!}
                ...
                {!! view_render_event('CastMart.shop.components.products.card.price.after') !!}
                ...
                <div class="action-items flex items-center justify-between opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 max-md:hidden">
                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                        {!! view_render_event('CastMart.shop.components.products.card.add_to_cart.before') !!}
                        ...
                        {!! view_render_event('CastMart.shop.components.products.card.add_to_cart.after') !!}
                    @endif
