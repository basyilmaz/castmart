...
<x-shop::layouts>
    ...
    @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
        <div class="mt-5 flex justify-center max-lg:hidden">
            {!! view_render_event('CastMart.shop.customers.account.compare.breadcrumbs.before') !!}

            <div class="flex items-center gap-x-2.5">
                <x-shop::breadcrumbs name="compare" />
            </div>

            {!! view_render_event('CastMart.shop.customers.account.compare.breadcrumbs.after') !!}
        </div>
    @endif
    ...
    @pushOnce('scripts')
        ...
        >
            <div>
                {!! view_render_event('CastMart.shop.customers.account.compare.before') !!}

                <div v-if="! isLoading">
                    <div class="flex items-center justify-between max-md:px-4">

                        {!! view_render_event('CastMart.shop.customers.account.compare.title.before') !!}

                        <h1 class="text-2xl font-medium max-sm:text-base">
                            @lang('shop::app.compare.title')
                        </h1>

                        {!! view_render_event('CastMart.shop.customers.account.compare.title.after') !!}

                        {!! view_render_event('CastMart.shop.customers.account.compare.remove_all.before') !!}
                        ...
                        {!! view_render_event('CastMart.shop.customers.account.compare.remove_all.after') !!}
                    </div>
                    ...
                    >
                        <template v-for="attribute in comparableAttributes">
                            ...
                            >
                                {!! view_render_event('CastMart.shop.customers.account.compare.attribute_name.before') !!}
                                ...
                                {!! view_render_event('CastMart.shop.customers.account.compare.attribute_name.after') !!}
                            ...
                            {!! view_render_event('CastMart.shop.customers.account.compare.comparable_attribute.before') !!}
                            ...
                            {!! view_render_event('CastMart.shop.customers.account.compare.comparable_attribute.after') !!}
                        </template>
                    </div>
                ...
                {!! view_render_event('CastMart.shop.customers.account.compare.after') !!}
            </div>
        </script>
