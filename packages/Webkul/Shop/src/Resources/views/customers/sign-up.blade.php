...
>
	...
	<div class="container mt-20 max-1180:px-5 max-md:mt-12">
        {!! view_render_event('CastMart.shop.customers.sign-up.logo.before') !!}
        ...
        <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
            <a
                ...
                aria-label="@lang('shop::app.customers.signup-form.CastMart')"
            >
                <img
		...
		<div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
            ...
            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop::form :action="route('shop.customers.register.store')">
                    {!! view_render_event('CastMart.shop.customers.signup_form_controls.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.signup_form.first_name.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.signup_form.last_name.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.signup_form.email.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.signup_form.password.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.signup_form.password_confirmation.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.signup_form.newsletter_subscription.after') !!}
                    ...
                    <div class="mt-8 flex flex-wrap items-center gap-9 max-sm:justify-center max-sm:gap-5">
                        ...
                        <div class="flex flex-wrap gap-4">
                            {!! view_render_event('CastMart.shop.customers.login_form_controls.after') !!}
                        </div>
                    </div>

                    {!! view_render_event('CastMart.shop.customers.signup_form_controls.after') !!}
