...
>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        {!! view_render_event('CastMart.shop.customers.forget_password.logo.before') !!}
        ...
        <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
            <a
                ...
                aria-label="@lang('shop::app.customers.forgot-password.CastMart')"
            >
                <img
        ...
        {!! view_render_event('CastMart.shop.customers.forget_password.logo.after') !!}
        ...
        >
            ...
            {!! view_render_event('CastMart.shop.customers.forget_password.before') !!}

            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop::form :action="route('shop.customers.forgot_password.store')">
                    {!! view_render_event('CastMart.shop.customers.forget_password_form_controls.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.forget_password_form_controls.email.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.forget_password_form_controls.after') !!}

                </x-shop::form>
            </div>

            {!! view_render_event('CastMart.shop.customers.forget_password.after') !!}
