<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto">
        ...
        {!! view_render_event('CastMart.shop.customers.account.gdpr.list.before') !!}
        ...
        {!! view_render_event('CastMart.shop.customers.account.gdpr.list.after') !!}
    </div>

    <!-- Login Form -->
    <x-shop::form action="{{ route('shop.customers.account.gdpr.store') }}">
        {!! view_render_event('CastMart.shop.customers.account.gdpr.request.form_controls.before') !!}
        ...
        {!! view_render_event('CastMart.shop.customers.account.gdpr.request.form_controls.after') !!}
    </x-shop::form>
</x-shop::layouts.account>
