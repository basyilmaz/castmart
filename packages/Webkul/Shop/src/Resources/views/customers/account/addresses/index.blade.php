<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto">
        ...
        @if (! $addresses->isEmpty())
            ...
            {!! view_render_event('CastMart.shop.customers.account.addresses.list.before', ['addresses' => $addresses]) !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.addresses.list.after', ['addresses' => $addresses]) !!}
        ...
        @else
            ...
            <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                <img 
                    ...
                    src="{{ CastMart_asset('images/no-address.png') }}" 
                    alt="Empty Address" 
                    title=""
                >
