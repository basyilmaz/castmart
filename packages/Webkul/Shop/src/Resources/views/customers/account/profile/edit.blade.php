<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        {!! view_render_event('CastMart.shop.customers.account.profile.edit.before', ['customer' => $customer]) !!}
        ...
        >
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.before', ['customer' => $customer]) !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.image.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.first_name.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.last_name.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.email.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.phone.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.gender.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.date_of_birth.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.old_password.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.new_password.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.new_password_confirmation.after') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_form_controls.after', ['customer' => $customer]) !!}

        </x-shop::form>

        {!! view_render_event('CastMart.shop.customers.account.profile.edit.after', ['customer' => $customer]) !!}
