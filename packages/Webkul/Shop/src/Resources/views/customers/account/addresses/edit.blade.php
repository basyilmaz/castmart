<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        {!! view_render_event('CastMart.shop.customers.account.address.edit.before', ['address' => $address]) !!}
        ...
        {!! view_render_event('CastMart.shop.customers.account.address.edit.after', ['address' => $address]) !!}
    </div>
    ...
    @push('scripts')
        ...
        >
            ...
            >
                {!! view_render_event('CastMart.shop.customers.account.address.edit_form_controls.before', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.company_name.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.first_name.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.last_name.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.email.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.vat_id.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.street-addres.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.country.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.state.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.city.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.postcode.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.addresses.edit_form_controls.phone.after', ['address' => $address]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.address.edit_form_controls.after', ['address' => $address]) !!}
