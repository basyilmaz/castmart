<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        <div class="flex items-center justify-between">
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_button.before') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.edit_button.after') !!}
        </div>

        <!-- Profile Information -->
        <div class="mt-8 grid grid-cols-1 gap-y-6 max-md:mt-5 max-sm:gap-y-4">
            {!! view_render_event('CastMart.shop.customers.account.profile.first_name.before') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.first_name.after') !!}

            {!! view_render_event('CastMart.shop.customers.account.profile.last_name.before') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.last_name.after') !!}

            {!! view_render_event('CastMart.shop.customers.account.profile.gender.before') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.gender.after') !!}

            {!! view_render_event('CastMart.shop.customers.account.profile.date_of_birth.before') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.date_of_birth.after') !!}

            {!! view_render_event('CastMart.shop.customers.account.profile.email.before') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.email.after') !!}

            {!! view_render_event('CastMart.shop.customers.account.profile.delete.before') !!}
            ...
            {!! view_render_event('CastMart.shop.customers.account.profile.delete.after') !!}
