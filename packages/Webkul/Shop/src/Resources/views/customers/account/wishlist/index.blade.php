    ...
    @pushOnce('scripts')
        ...
        >
            <div>
                ...
                {!! view_render_event('CastMart.shop.customers.account.wishlist.list.before') !!}
                ...
                <template v-else>
                    <div class="flex items-center justify-between">
                        ...
                        {!! view_render_event('CastMart.shop.customers.account.wishlist.delete_all.before') !!}
                        ...
                        {!! view_render_event('CastMart.shop.customers.account.wishlist.delete_all.after') !!}
                    </div>
                    ...
                    <template v-else>
                        <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                            <img
                                ...
                                src="{{ CastMart_asset('images/wishlist.png') }}"
                                alt="Empty wishlist"
                            >
                ...
                {!! view_render_event('CastMart.shop.customers.account.wishlist.list.after') !!}
            </div>
        </script>
                    ...
                    <div class="grid gap-y-6 max-md:gap-y-0">
                        ...
                        <div class="flex justify-between gap-x-2.5 border-b border-zinc-200 pb-5">
                            <div class="flex gap-x-5 max-md:w-full max-md:gap-x-5">
                                <div>
                                    {!! view_render_event('CastMart.shop.customers.account.wishlist.image.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.shop.customers.account.wishlist.image.after') !!}
                                </div>
                                ...
                                <div class="grid gap-y-2.5 max-md:w-full max-md:gap-y-0">
                                    ...
                                    <div class="max-md:block md:hidden">
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.wishlist.remove_button.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.wishlist.remove_button.after') !!}
                                    </div>

                                    {!! view_render_event('CastMart.shop.customers.account.wishlist.perform_actions.before') !!}
                                    ...
                                    {!! view_render_event('CastMart.shop.customers.account.wishlist.perform_actions.after') !!}
                                </div>
                            </div>
