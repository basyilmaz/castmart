        ...
        >
            <div>
                <x-shop::form :action="route('shop.customers.account.addresses.store')">
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.company_name.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.first_name.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.last_name.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.email.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.vat_id.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.street_address.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.state.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.city.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.postcode.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.phone.after') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.account.addresses.create_form_controls.after') !!}
                </x-shop::form>
                {!! view_render_event('CastMart.shop.customers.account.address.create.after') !!}
            </div>
        </script>
