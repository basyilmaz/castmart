<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        {!! view_render_event('CastMart.shop.customers.account.downloadable_products.list.before') !!}
        ...
        {!! view_render_event('CastMart.shop.customers.account.downloadable_products.list.after') !!}
