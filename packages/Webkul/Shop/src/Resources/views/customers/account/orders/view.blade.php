    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-1.5">
                {!! view_render_event('CastMart.shop.customers.account.orders.reorder_button.before', ['order' => $order]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.orders.reorder_button.after', ['order' => $order]) !!}

                {!! view_render_event('CastMart.shop.customers.account.orders.cancel_button.before', ['order' => $order]) !!}
                ...
                {!! view_render_event('CastMart.shop.customers.account.orders.cancel_button.after', ['order' => $order]) !!}
            </div>
        </div>

        {!! view_render_event('CastMart.shop.customers.account.orders.view.before', ['order' => $order]) !!}
                            ...
                            <div class="flex-auto">
                                <div class="flex justify-end">
                                    <div class="grid max-w-max gap-2 text-sm">
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.subtotal.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.subtotal.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.shipping.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.shipping.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.tax-amount.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.tax-amount.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.discount.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.discount.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.grand-total.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.grand-total.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.total-paid.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.total-paid.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.total-refunded.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.total-refunded.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.total-due.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.information.total-due.after') !!}
                                ...
                                <div class="grid gap-4 md:hidden">
                                    ...
                                    <div class="w-full rounded-md bg-gray-100">
                                        ...
                                        <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                                            ...
                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.subtotal.before') !!}
                                            ...
                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.subtotal.after') !!}

                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.shipping.before') !!}
                                            ...
                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.shipping.after') !!}

                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.discount.before') !!}
                                            ...
                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.discount.after') !!}

                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.tax.before') !!}
                                            ...
                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.tax.after') !!}

                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.grand-total.before') !!}
                                            ...
                                            {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.grand-total.after') !!}
                                    ...
                                    <div class="mt-8 flex items-start gap-10 max-lg:gap-5">
                                        <div class="flex flex-auto justify-end">
                                            <div class="grid max-w-max gap-2 text-sm">
                                                ...
                                                {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.tax-amount.before') !!}
                                                ...
                                                {!! view_render_event('CastMart.shop.customers.account.orders.view.invoices.tax-amount.after') !!}
                            ...
                            <div class="grid gap-4 md:hidden">
                                ...
                                <div class="w-full rounded-md bg-gray-100">
                                    ...
                                    <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.subtotal.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.subtotal.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.shipping.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.shipping.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.discount.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.discount.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.tax-amount.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.tax-amount.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.adjustment-refund.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.adjustment-refund.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.adjustment-fee.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.adjustment-fee.after') !!}

                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.grand-total.before') !!}
                                        ...
                                        {!! view_render_event('CastMart.shop.customers.account.orders.view.refunds.grand-total.after') !!}
                ...
                <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                    ...
                    @if ($order->shipping_address)
                        <div class="text-sm font-medium text-zinc-500">
                            ...
                            <div class="mt-1 grid gap-2 text-xs text-black">
                                ...
                                {!! view_render_event('CastMart.shop.customers.account.orders.view.shipping_address_details.after', ['order' => $order]) !!}
                            </div>

                            {!! view_render_event('CastMart.shop.customers.account.orders.view.shipping_address.after', ['order' => $order]) !!}
                    ...
                    @if ($order->billing_address)
                        <div class="text-sm font-medium text-zinc-500">
                            ...
                            <div class="mt-1 grid gap-2 text-xs text-gray-800">
                                ...
                                {!! view_render_event('CastMart.shop.customers.account.orders.view.billing_address_details.after', ['order' => $order]) !!}

                            </div>

                            {!! view_render_event('CastMart.shop.customers.account.orders.view.billing_address.after', ['order' => $order]) !!}
                    ...
                    @if ($order->shipping_address)
                        <div class="text-sm font-medium text-zinc-500">
                            ...
                            <div class="mt-1 grid gap-2.5 text-xs text-gray-800">
                                ...
                                {!! view_render_event('CastMart.shop.customers.account.orders.view.shipping_method_details.after', ['order' => $order]) !!}
                            </div>

                            {!! view_render_event('CastMart.shop.customers.account.orders.view.shipping_method.after', ['order' => $order]) !!}
                    ...
                    <div class="text-sm font-medium text-zinc-500">
                        ...
                        <div class="mt-1 grid gap-2.5 text-xs text-black">
                            ...
                            {!! view_render_event('CastMart.shop.customers.account.orders.view.payment_method_details.after', ['order' => $order]) !!}

                        </div>

                        {!! view_render_event('CastMart.shop.customers.account.orders.view.payment_method.after', ['order' => $order]) !!}
                    </div>
                </div>
            </div>
        ...
        {!! view_render_event('CastMart.shop.customers.account.orders.view.after', ['order' => $order]) !!}
