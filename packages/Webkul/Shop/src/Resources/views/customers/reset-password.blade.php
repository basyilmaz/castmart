...
>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        {!! view_render_event('CastMart.shop.customers.reset_password.logo.before') !!}
        ...
        <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
            <a
                ...
                aria-label="@lang('shop::app.customers.reset-password.CastMart')"
            >
                <img
        ...
        {!! view_render_event('CastMart.shop.customers.reset_password.logo.after') !!}
        ...
        <div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
            ...
            {!! view_render_event('CastMart.shop.customers.reset_password.before') !!}
            ...
            <div class="mt-14 rounded max-sm:mt-8">
                ...
                <x-shop::form :action="route('shop.customers.reset_password.store')" >
                    ...
                    {!! view_render_event('CastMart.shop.customers.reset_password_form_controls.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.reset_password_form_controls.after') !!}

                    {!! view_render_event('CastMart.shop.customers.reset_password.submit_button.before') !!}
                    ...
                    {!! view_render_event('CastMart.shop.customers.reset_password.submit_button.after') !!}
                </x-shop::form>
            </div>

            {!! view_render_event('CastMart.shop.customers.reset_password.after') !!}
